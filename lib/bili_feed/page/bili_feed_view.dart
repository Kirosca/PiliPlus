...
class BiliFeedPage extends StatefulWidget {
  const BiliFeedPage({super.key});

  @override
  State<BiliFeedPage> createState() => _BiliFeedPageState();
}

class _BiliFeedPageState extends State<BiliFeedPage>
    with AutomaticKeepAliveClientMixin {
  final controller = Get.putOrFind(BiliFeedController.new);
  ...
  Widget _buildBody(
    ...
    LoadingState<List<BiliFeedVideoItemModel>?> loadingState,
  ) {
...
// 别名保证向后兼容
typedef CuratedFeedPage = BiliFeedPage;
